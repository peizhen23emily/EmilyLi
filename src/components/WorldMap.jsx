...
const cities = [
  { name: 'Chengdu', lat: 30.5728, lng: 104.0668, type: 'hometown', description: ' Home sweet home' },
  ...
  { name: 'Barcelona', lat: 41.3851, lng: 2.1734, type: 'visited', description: '✈️ 2024.03' },
  { name: 'Paris', lat: 48.8566, lng: 2.3522, type: 'visited', description: '✈️ 2023.12' },
  { name: 'Vancouver', lat: 49.2827, lng: -123.1207, type: 'visited', description: '✈️ 2022.04' },
  { name: 'Montreal', lat: 45.5017, lng: -73.5673, type: 'visited', description: '✈️ 2023.04' },
  { name: 'Kelowna', lat: 49.6832, lng: -120.4055, type: 'visited', description: '✈️ 2023.04' },
  { name: 'Quebec City', lat: 46.8139, lng: -71.2080, type: 'visited', description: '✈️ 2023.04' },
  { name: 'London', lat: 51.5074, lng: -0.1278, type: 'visited', description: '✈️ 2022.06' },
  { name: 'Bangkok', lat: 13.7563, lng: 100.5018, type: 'visited', description: '✈️ 2018.12' },
  { name: 'Istanbul', lat: 41.0082, lng: 28.9784, type: 'visited', description: '✈️ 2022.10' },
  { name: 'Sydney', lat: -33.8688, lng: 151.2093, type: 'visited', description: '✈️ 2019.12' },
  { name: 'New York', lat: 40.7128, lng: -74.0060, type: 'visited', description: '✈️ 2023.05' },
  { name: 'Tampa', lat: 27.9506, lng: -82.4572, type: 'visited', description: '✈️ 2025.04' },
  { name: 'Orlando', lat: 28.5421, lng: -81.3774, type: 'visited', description: '✈️ 2025.04' },
  { name: 'Chicago', lat: 41.8781, lng: -87.6298, type: 'visited', description: '✈️ 2025.10' },
  { name: 'Hawaii', lat: 21.3099, lng: -157.8581, type: 'visited', description: '✈️ 2023.12' },
  { name: 'Osaka', lat: 34.6852, lng: 135.4328, type: 'visited', description: '✈️ 2011.07' },
]
